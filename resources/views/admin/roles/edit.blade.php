            ...
            <div class="col-12">
                <div class="card text-white bg-dark border-light">
                    <div class="card-header">
                        <h1 class="h4 mb-0">✏️ تعديل الدور</h1>
                    </div>
                    <div class="card-body">
                        <p class="card-text text-muted mb-4">تعديل بيانات الدور: {{ $role->name }}</p>
                        <form action="{{ route('admin.roles.update', $role) }}" method="POST">
                                    ...
                                    @foreach ($permissions as $permission)
                                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                            ...
                                            <div class="permission-item p-2 border rounded cursor-pointer" 
                                                 ...
                                                 style="@if(in_array($permission->id, $rolePermissions)) background-color: var(--bs-primary); border-color: var(--bs-primary); @endif">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                                <button type="submit" class="btn btn-primary flex-fill">تحديث الدور</button>
